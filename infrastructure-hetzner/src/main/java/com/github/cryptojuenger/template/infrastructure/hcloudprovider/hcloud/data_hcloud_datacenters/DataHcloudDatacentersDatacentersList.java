...
@javax.annotation.Generated(value = "jsii-pacmak/1.93.0 (build 1706ca5)", date = "2024-01-28T13:37:41.263Z")
@software.amazon.jsii.Jsii(module = com.github.cryptojuenger.template.infrastructure.hcloudprovider.hcloud.$Module.class, fqn = "hcloud.dataHcloudDatacenters.DataHcloudDatacentersDatacentersList")
public class DataHcloudDatacentersDatacentersList extends com.hashicorp.cdktf.ComplexList {

    protected DataHcloudDatacentersDatacentersList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataHcloudDatacentersDatacentersList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public DataHcloudDatacentersDatacentersList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull com.github.cryptojuenger.template.infrastructure.hcloudprovider.hcloud.data_hcloud_datacenters.DataHcloudDatacentersDatacentersOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(com.github.cryptojuenger.template.infrastructure.hcloudprovider.hcloud.data_hcloud_datacenters.DataHcloudDatacentersDatacentersOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<com.github.cryptojuenger.template.infrastructure.hcloudprovider.hcloud.data_hcloud_datacenters.DataHcloudDatacentersDatacenters> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
