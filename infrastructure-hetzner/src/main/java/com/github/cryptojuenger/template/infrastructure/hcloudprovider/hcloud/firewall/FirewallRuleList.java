...
@software.amazon.jsii.Jsii(module = com.github.cryptojuenger.template.infrastructure.hcloudprovider.hcloud.$Module.class, fqn = "hcloud.firewall.FirewallRuleList")
public class FirewallRuleList extends com.hashicorp.cdktf.ComplexList {

    protected FirewallRuleList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected FirewallRuleList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public FirewallRuleList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull com.github.cryptojuenger.template.infrastructure.hcloudprovider.hcloud.firewall.FirewallRuleOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(com.github.cryptojuenger.template.infrastructure.hcloudprovider.hcloud.firewall.FirewallRuleOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<com.github.cryptojuenger.template.infrastructure.hcloudprovider.hcloud.firewall.FirewallRule> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
