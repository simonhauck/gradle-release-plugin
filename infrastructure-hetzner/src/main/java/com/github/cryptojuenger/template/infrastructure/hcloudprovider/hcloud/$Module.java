package com.github.cryptojuenger.template.infrastructure.hcloudprovider.hcloud;
...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("com/github/cryptojuenger/template/infrastructure/hcloudprovider/hcloud/$Module.txt");
    ...
    public $Module() {
        super("hcloud", "0.0.0", $Module.class, "hcloud@0.0.0.jsii.tgz");
    }
