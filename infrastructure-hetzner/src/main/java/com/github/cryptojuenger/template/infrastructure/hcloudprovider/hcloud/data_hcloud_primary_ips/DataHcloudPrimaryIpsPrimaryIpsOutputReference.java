...
@software.amazon.jsii.Jsii(module = com.github.cryptojuenger.template.infrastructure.hcloudprovider.hcloud.$Module.class, fqn = "hcloud.dataHcloudPrimaryIps.DataHcloudPrimaryIpsPrimaryIpsOutputReference")
public class DataHcloudPrimaryIpsPrimaryIpsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DataHcloudPrimaryIpsPrimaryIpsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataHcloudPrimaryIpsPrimaryIpsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public @org.jetbrains.annotations.Nullable com.github.cryptojuenger.template.infrastructure.hcloudprovider.hcloud.data_hcloud_primary_ips.DataHcloudPrimaryIpsPrimaryIps getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(com.github.cryptojuenger.template.infrastructure.hcloudprovider.hcloud.data_hcloud_primary_ips.DataHcloudPrimaryIpsPrimaryIps.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable com.github.cryptojuenger.template.infrastructure.hcloudprovider.hcloud.data_hcloud_primary_ips.DataHcloudPrimaryIpsPrimaryIps value) {
